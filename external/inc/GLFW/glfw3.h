 ...
 *
 *  @errors Possible errors inc @ref GLFW_PLATFORM_ERROR.
 *
 ...
 *
 *  @errors Possible errors inc @ref GLFW_INVALID_ENUM and @ref
 *  GLFW_INVALID_VALUE.
 *
 ...
 *
 *  @errors Possible errors inc @ref GLFW_NOT_INITIALIZED.
 *
 ...
 *
 *  @errors Possible errors inc @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 ...
 *
 *  @errors Possible errors inc @ref GLFW_NOT_INITIALIZED, @ref
 ...
 *  The selected images will be rescaled as needed.  Good sizes inc 16x16,
 *  32x32 and 48x48.
 *
